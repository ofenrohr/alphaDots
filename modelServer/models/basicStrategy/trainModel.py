...
trainingDataset = 'basicStrategy5x4-2.npz'
modelPath = 'model/basicStrategy.h5'
...
# Load the data
#
firstTryDataset = np.load(trainingDataset)
...
model.fit(x_train, y_cat, epochs=50, batch_size=64, callbacks=callbacks, validation_split=0.001)
